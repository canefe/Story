...
class CallLocationCommand(private val commandUtils: LocationCommandUtils) {
	fun getCommand(): CommandAPICommand = CommandAPICommand("call")
		...
		.executesPlayer(
			PlayerCommandExecutor { player, args ->
				...
				try {
					...
					player.sendSuccess("Called all nearby NPCs within $radius blocks to your location. They will arrive shortly.")
