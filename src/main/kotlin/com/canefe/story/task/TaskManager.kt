...
class TaskManager private constructor(private val plugin: Story) {
	 ...
	 */
	fun selectDialogueOption(taskId: Int, optionNumber: Int, player: CommandSender? = null): Boolean {
		...
		// Notify players with permission
		val selectionMessage = "<dark_gray>[<gold>Dialogue</gold>]</dark_gray>" +
	 ...
	 */
	private fun handleDialoguePathSelection(taskId: Int, optionNumber: Int) {
	 ...
	 */
	private fun sendDialoguePathRequest(sender: CommandSender, task: DialoguePathTask) {
		val mm = plugin.miniMessage
		...
		val option1Button = CommandComponentUtils.createButton(
			mm,
			"Option 1",
			"green",
			"run_command",
		...
		val option2Button = CommandComponentUtils.createButton(
			mm,
			"Option 2",
			"yellow",
			"run_command",
		...
		val option3Button = CommandComponentUtils.createButton(
			mm,
			"Option 3",
			"red",
			"run_command",
