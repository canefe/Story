 ...
 */
class SkillManager(private val plugin: Story) {
	 ...
	 */
	fun registerSkillProvider(id: String, factory: (UUID, Boolean) -> SkillProvider) {
	 ...
	 */
	fun createProviderForCharacter(characterId: UUID, isPlayer: Boolean): SkillProvider {
