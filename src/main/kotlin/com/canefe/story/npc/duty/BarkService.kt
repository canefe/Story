 ...
 */
class BarkService private constructor(private val plugin: Story) {
	 ...
	 */
	fun trySpeak(npc: NPC, poolName: String, location: com.canefe.story.location.data.StoryLocation): Boolean {
