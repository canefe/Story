...
data class Leader(
	...
	companion object {
		...
		fun generateRandom(prefix: String): Leader {
			...
			val titles =
				mapOf(
					"settlement" to listOf("Lord", "Lady", "Baron", "Baroness", "Count", "Countess", "Mayor", "Elder", "Chief"),
					"faction" to listOf("King", "Queen", "Emperor", "Empress", "High Lord", "Grand Duke", "Archduke", "Chancellor"),
				)
