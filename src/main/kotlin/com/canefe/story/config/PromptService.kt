...
class PromptService(private val plugin: Story) {
	...
	fun getPrompt(promptKey: String): String {
		return promptsConfig.getString("$promptKey.system_prompt") ?: ""
	}

	/** Gets a prompt with variables replaced */
	fun getPrompt(promptKey: String, variables: Map<String, String>): String {
	...
	fun getBehavioralDirectivePrompt(recentMessages: String, relationshipContext: String, npcName: String): String {
		val variables =
			mapOf(
	...
	fun getSpeakerSelectionPrompt(availableCharacters: String): String {
		return getPrompt("speaker_selection", mapOf("available_characters" to availableCharacters))
	}

	/** Gets the memory significance evaluation prompt */
	fun getMemorySignificancePrompt(): String {
		return getPrompt("memory_significance")
	}

	/** Gets the NPC name generation prompt */
	fun getNpcNameGenerationPrompt(location: String, role: String, context: String): String {
	...
	fun getNpcGreetingPrompt(npcName: String, target: String): String {
	...
	fun getNpcCharacterGenerationPrompt(npcName: String, location: String): String {
	...
	fun getNpcPopulationPlanningPrompt(location: String, context: String, npcCount: Int): String {
		val variables =
			mapOf(
	...
	fun getTalkAsNpcPrompt(npcName: String, message: String): String {
